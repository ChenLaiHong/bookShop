...
<HTML>
	...
	function showDetail(oid){
		...
		//打开连接
		xhr.open("GET","${pageContext.request.contextPath}/adminOrder_findOrderItem.action?dtime="+new Date().getTime()+"&oid="+oid,true);
		//发送
		xhr.send(null);
		but.value = "关闭";
		}else{
				...
				<TBODY>
							...
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<s:iterator var="order" value="pageBean.list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="7%">
												<s:property value="#order.messages"/>
											</td>
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="7%">
					...
					<tr align="center">
						...
						<s:if test=" pageBean.page !=pageBean.totalPage">	
							...
							<a href="${pageContext.request.contextPath}/adminOrder_findAll.action?page=<s:property value="pageBean.totalPage"/>">末页</a>
						</s:if>
						</TD>
					</tr>
				</TBODY>
