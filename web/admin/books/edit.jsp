...
<HTML>
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminBook_update.action" method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" >
						<input type="text" name="bname" value="<s:property value="model.bname"/>" id="userAction_save_do_logonName" class="bg"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						所属的二级分类：
					</td>
					...
					<td class="ta_01" bgColor="#ffffff" >
						<input type="text" name="author" value="<s:property value="model.author"/>" id="userAction_save_do_logonName" class="bg"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						图书出版社：
					</td>
					<td class="ta_01" bgColor="#ffffff" >
						<input type="text" name="book_concern" value="<s:property value="model.book_concern"/>" id="userAction_save_do_logonName" class="bg"/>
				...
				<td width="8%" align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff" >
						<input type="text" name="number" value="<s:property value="model.number"/>" id="userAction_save_do_logonName" class="bg"/>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<textarea rows="5" cols="28" name="book_desc"><s:property value="model.book_desc"/></textarea>
					</td>
				</tr>
				<tr>
