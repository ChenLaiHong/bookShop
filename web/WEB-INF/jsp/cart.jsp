			...
			<div class="step step1">
				...
				<table>
					...
					<s:iterator var="cartItem" value="#session.cart.cartItems">
						<tr>
							<td width="60">
								<img src="${pageContext.request.contextPath}/<s:property value="#cartItem.book.image"/>"/>
							</td>
							<td>
								<a target="_blank"><s:property value="#cartItem.book.bname"/></a>
							</td>
							<td>
								￥<s:property value="#cartItem.book.shop_price"/>
							</td>
							...
							<td>
								<a href="${pageContext.request.contextPath}/cart_removeCart.action?bid=<s:property value="#cartItem.book.bid"/>" class="delete">删除</a>
							</td>
						</tr>
					</s:iterator>
				</tbody></table>
