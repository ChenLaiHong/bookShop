...
<div class="container productContent">
		<div class="span6">
			<div class="hotProductCategory">
				<s:iterator var="c" value="#session.cList">
						<dl>
							<dt>
								<a href="${pageContext.request.contextPath}/book_findByCid.action?cid=<s:property value="#c.cid"/>&page=1"><s:property value="#c.cname"/></a>
							</dt>
		...
		<div class="span18 last">
			...
			<div class="sn">
				<div>编号：<s:property value="model.bid"/></div>
			</div>
			<div class="info">
				<dl>
					<dt>小驿价:</dt>
					...
					<dl>
						<dt>作者:</dt>
						<dd><s:property value="model.author"/></dd>
					</dl>
					<dl>
						<dt>出版社:</dt>
						<dd><s:property value="model.book_concern"/></dd>
					</dl>
					<dl>
						<dt>    </dt>
						<dd>
			...
			<div id="bar" class="bar">
				...
				<div id="introduction" name="introduction" class="introduction">
					<div class="title">
						<strong><s:property value="model.book_desc"/></strong>
					</div>
					<div>
