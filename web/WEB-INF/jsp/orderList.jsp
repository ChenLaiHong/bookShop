				...
				<tbody>
					<s:iterator var="order" value="pageBean.list">
						<tr>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">
								...
								<s:if test="#order.state == 4">
									交易成功
									<a href="${ pageContext.request.contextPath }/order_comment.action?oid=<s:property value="#order.oid" />"><font color="red">评论</font></a>
						...
						<s:iterator var="orderItem" value="#order.orderItems">
							<tr>
								<td width="60"><img
									src="${ pageContext.request.contextPath }/<s:property value="#orderItem.book.image"/>" />
								</td>
								<td><s:property value="#orderItem.book.bname" /></td>
								<td><s:property value="#orderItem.book.shop_price" /></td>
